      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(titleData[0], style: TextStyle(fontSize: 14)),
              const Spacer(),
              Text(titleData[1], style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
              Text(titleData[2], style: TextStyle(fontSize: 16)),
            ],
          ),
          Row(
            children: [
              Text(titleData[3], style: TextStyle(fontSize: 14)),
